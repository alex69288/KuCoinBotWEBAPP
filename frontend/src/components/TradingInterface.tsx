...
const TradingInterface: React.FC = () => {
  ...
  return (
    ...
    <div data-testid="page-container" className="bg-gray-100 pt-4 pb-6 h-screen flex flex-col">
