...
const resources = {
  en: {
    translation: {
      ...
      emaThreshold: 'EMA Threshold (%)',
      mlBuyThreshold: 'ML Buy Threshold',
      mlSellThreshold: 'ML Sell Threshold',
      takeProfitPercent: 'Take Profit (%)',
      stopLossPercent: 'Stop Loss (%)',
      minHoldTime: 'Min Hold Time (min)',
      ...
      clearDemoTrades: 'Clear Demo Trades',
      demoTrades: 'Demo Trades',
      tradeDescription: '{{side}} {{amount}} {{symbol}} at ${{price}} on {{timestamp}}',
      marketUpdate: 'Market Update',
      signal: 'Signal',
      positions: 'Positions',
      viewOpenPositions: 'View positions',
  ...
  ru: {
    translation: {
      ...
      slowPeriod: 'Период медленной EMA',
      emaThreshold: 'Порог EMA (%)',
      mlBuyThreshold: 'Порог ML для покупки',
      mlSellThreshold: 'Порог ML для продажи',
      takeProfitPercent: 'Take Profit (%)',
      stopLossPercent: 'Stop Loss (%)',
      minHoldTime: 'Мин. время удержания (мин)',
      trailingStop: 'Trailing Stop',
      ...
      priceActionStrategyDescription: 'Support/resistance levels and candlestick patterns analysis',
      demoMode: 'Демо режим',
      enableDemoMode: 'Включить демо режим',
      disableDemoMode: 'Выключить демо режим',
      clearDemoTrades: 'Очистить демо сделки',
      demoTrades: 'Демо сделки',
      tradeDescription: '{{side}} {{amount}} {{symbol}} по цене ${{price}} в {{timestamp}}',
      ...
      history: 'История',
      settings: 'Настройки',
      orderCancelled: 'Заказ отменен успешно',
