# Changelog
## [v0.0.50] - 2025-11-16
- Изменены статусы ML: теперь предсказывает категории (сильный рост >70%, умеренный рост 60-70%, нейтрально 50-60%, умеренное падение 40-50%, сильное падение <40%) вместо числовых вероятностей.
