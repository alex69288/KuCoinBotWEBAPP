...
## [v0.0.52] - 2025-11-16
- UI/Telegram: ML статус теперь отображается CAPS (например, "СИЛЬНЫЙ РОСТ", "УМЕРЕННЫЙ РОСТ", "НЕЙТРАЛЬНО", "УМЕРЕННОЕ ПАДЕНИЕ", "СИЛЬНОЕ ПАДЕНИЕ") — соответствует стилю остальных карточек.
