...
5. **Добавьте** переменную `BACKEND_URL` со значением `https://kucoinbot-backend-alex69288.amvera.io`
6. Сохраните изменения
7. Перезапустите сервис
8. Проверьте логи через 2-3 минуты
...
**Решение:** Добавьте `BACKEND_URL=https://kucoinbot-backend-alex69288.amvera.io`#### ❌ В логах: "REDIS_URL=present"
